...
float4 frag(fragmentInput i) : COLOR {
    ...
    float4 diffuseColor = tex2D(_MainTex, i.uv);
    float3 diffuseReflection = diffuseColor.rgb * diffuseLevel * i.color * _LightColor0.rgb;
    float3 specularReflection = _SpecularColor.rgb * specularLevel * i.color * _LightColor0.rgb;
